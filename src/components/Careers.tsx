        ...
        <div className="md:flex">
          ...
          <div className="p-6 md:w-2/3">
            ...
            <p className="text-gray-600 mb-4">
              Home Credit Việt Nam luôn tìm kiếm những tài năng để cùng phát
              triển và mang đến những giải pháp tài chính tốt nhất cho khách
              hàng. Chúng tôi cung cấp môi trường làm việc chuyên nghiệp, năng
              động và nhiều cơ hội phát triển.
            </p>
